    ...
    return (
        <div>
            ...
            <div className='mt-10 text-right'>
                <h1 className='text-red text-9xl m-3'>ABOUT</h1>
            ...
            <div className='flex items-center bg-red min-h-[70vh] p-10 animate__animated animate__fadeInUp'>
                ...
                <div className='m-4 w-1/2 flex justify-center items-center'>
                    <img src={tridish} className='tridish h-[25rem] w-[42rem]'></img>
                </div>
            </div>
        </div>
    )
