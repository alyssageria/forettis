...
function Home({ currentPage }) {
    return (
        <div className='home h-[80vh]'>
            <div className='h-[80vh] flex justify-center items-center flex-col animate__animated animate__fadeInUp'>
            ...
            <div className='grid grid-cols-2 h-screen m-10'>
                <div className='flex justify-center items-center animate__animated animate__fadeInLeft'>
                    <img src={pizzaOven} className='pizzaImage h-[27rem] w-[35rem]'></img>
                </div>
                <div className='flex justify-center items-center flex-col animate__animated animate__fadeInRight'>
                    <h2 className='text-red text-center text-5xl italic'>Centuries of Italian Tradition</h2>
                    <p className='text-2xl text-center p-5'>Foretti's is a celebration of Italian traditions, specializing in authentic Associazione Verace Pizza Napoletana-certified wood-fired pizzas baked in a 900 degree oven with the same techniques and ingredients used in Naples, Italy. We also feature house-made pastas and favorite dishes from across Italy</p>
                ...
                <div className='flex justify-center items-center flex-col animate__animated animate__fadeInRight'>
                    <h2 className='text-red text-center text-5xl italic'>Our History</h2>
                    <p className='text-2xl text-center p-5'>Foretti's CDM established itself as a highlight of the Newport Beach dining scene when it opened in 2013. Operating under the new ownership of longtime Restaurateur and Level 1 Sommelier Thaddeus Foret, we continue to prepare our signature recipes, created by the restaurant's namesake chef and his culinary team—many of whom remain in our kitchen today.</p>
                    <button className='text-red text-xl border-solid border-red border-2 m-3 p-2 pb-1 rounded hover:bg-red hover:text-white transition-all duration-200 ease-in-out'>
                        <Link
                            to='/about'
                            // onClick={() => handlePageChange('Menu')}
                ...
                <div className='flex justify-center items-center animate__animated animate__fadeInLeft'>
                    <img src={forettisRestaurant} className='restaurantImage h-[27rem] w-[35rem]'></img>
                </div>
            </div>
        </div>
    )
